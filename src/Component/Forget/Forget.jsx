             ...
             <div className="mt-12">
               ...
               <form onSubmit={handleSubmit} className='mt-8'>
                    ...
                    <div className='flex justify-center mt-4'>
                      <button className='font-sans font-black text-[26px] text-white w-[330px] p-1 bg-[#5C7BE0] text-center rounded-[8px] hover:bg-[#4a68c4] active:scale-50' type="submit"> Forget Reset </button>
                    </div>

                    {/* Link to Register  */}
                    <div className='flex justify-center mt-4'>
                        <Link className='font-sans font-normal text-[18px] text-[#393a79]' to='/login'>Back to  <span className='text-[#5d3ff2] font-semibold'>LOGIN FORGET</span></Link>
                    </div>
               </form>
             </div>
           </div>
